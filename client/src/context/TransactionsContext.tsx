...
import type { TransactionType, TransactionInput } from "../types/types";
...
export function TransactionsProvider({ children }: { children: ReactNode }) {
    ...
    const createTransaction: TransactionsContextValue["createTransaction"] = async (transaction: TransactionInput) => {
    ...
    return (
        <TransactionsContext.Provider value={{ transactions, income, expenses, getTransaction, createTransaction, deleteAllTransactions, deleteTransaction, updateAmount }}>
            {children}
